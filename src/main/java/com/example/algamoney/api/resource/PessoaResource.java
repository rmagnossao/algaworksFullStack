...
public class PessoaResource {
	...
	@GetMapping("/{codigo}")
	public ResponseEntity<Pessoa> listarPessoa(@PathVariable Long codigo) {
		
		return this.pessoaRepository.findByCodigo(codigo).map(pessoa -> ResponseEntity.ok(pessoa)).
